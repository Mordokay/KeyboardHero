...
public class letterManager : MonoBehaviour {
    ...
    public void rightKeySound() {
        Camera.main.transform.Find("rightKeyPress").GetComponent<AudioSource>().Play();
    }

    public void newLineSound()
    {
        Camera.main.transform.Find("newLinePress").GetComponent<AudioSource>().Play();
    }
